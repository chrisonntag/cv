...
{M.Sc. Computer Science, minor in Data Science | Expected 2023}

\block{University of Passau, Germany}
{B.Sc. Internet Computing | 2020}
{
    Coursework (a.o.): Software Engineering; Networks; Algorithms and Data Structures; System Security; Collaborative Interactive Learning, (Residual) Neural Networks.
}
...
{
    \begin{itemize}[-]
        \item Course planning of ``Grundkurs: Programmierung'' for students with a non-computer-science background (multiple weekend courses over the semester)
